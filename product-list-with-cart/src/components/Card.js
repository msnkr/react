      ...
      <div>
        <div className="card-start">
          <div className="card-image relative">
            ...
            <div className="basket absolute top-[260px] left-1/2 translate -translate-x-1/2">
              <p className="add-to-cart cursor-pointer bg-white px-8 py-3 rounded-full flex border-2 border-black">
                {" "}
                <span className="mr-4">
                  {" "}
                  <svg
