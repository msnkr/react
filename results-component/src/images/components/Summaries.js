export function ReactionSummary({ score }) {
  return (
    <div className="w-full flex justify-between bg-light-red/25 px-6 py-4 rounded-xl">
      <div className="flex space-x-4 items-center">
        ...
        <div>
          <p className="font-semibold text-light-red text-lg">Reaction</p>
        </div>
      </div>
      <div>
        <p>
...
export function MemorySummary({ score }) {
  return (
    <div className="w-full flex justify-between bg-orangey-yellow/25 px-6 py-4 rounded-xl">
      <div className="flex space-x-4 items-center">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <p className="font-semibold text-orangey-yellow text-lg">Memory</p>
        </div>
      </div>
      <div>
        <p>
...
export function VerbalSummary({ score }) {
  return (
    <div className="w-full flex justify-between bg-green-teal/25 px-6 py-4 rounded-xl">
      <div className="flex space-x-4 items-center">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <p className="font-semibold text-green-teal text-lg">Verbal</p>
        </div>
      </div>
      <div>
        <p>
...
export function VisualSummary({ score }) {
  return (
    <div className="w-full flex justify-between bg-cobalt-blue/25 px-6 py-4 rounded-xl">
      <div className="flex space-x-4 items-center">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div>
          <p className="font-semibold text-cobalt-blue text-lg">Visual</p>
        </div>
      </div>
      <div>
        <p>
